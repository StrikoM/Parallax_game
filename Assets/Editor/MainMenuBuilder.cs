...
public class MainMenuBuilder : EditorWindow
{
    ...
    {
        // Предохранитель от случайной перезаписи сцены главного меню!
        bool confirm = EditorUtility.DisplayDialog("Внимание!", 
            "Вы собираетесь полностью ПЕРЕСОБРАТЬ Главное Меню с нуля.\n\nЭто действие УДАЛИТ текущую сцену меню и сбросит все ваши ручные изменения координат кнопок!\n\nВы уверены, что хотите продолжить?", 
            "Да, пересобрать", "Отмена");
